...
Curated mime-types dataset (v1, 20 records) used by related lookup tools.

Canonical name: `mime-types`

## When to use this

- Use when an agent needs the mime-types reference dataset or related lookup metadata.
