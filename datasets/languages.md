...
Curated languages dataset (v1, 20 records) used by related lookup tools.

Canonical name: `languages`

## When to use this

- Use when an agent needs the languages reference dataset or related lookup metadata.
